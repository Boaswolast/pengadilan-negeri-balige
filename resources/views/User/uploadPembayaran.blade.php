...
<div class="content body-user">
    ...
    <!-- Centered card -->
    <center><h5 class="mt-3" style="color: white">Kirim Bukti Pembayaran Sesuai dengan SKUM!</h5></center>
    <div class="row">
        <div class="col-lg-8 offset-lg-2 mt-4">
            <div class="card">
                <div class="card-body border-top">
                    ...
                    <form action="{{route('pembayaran', ['id' => $data->id_pembayaran])}}" method="POST" enctype="multipart/form-data" novalidate>
                        @csrf
