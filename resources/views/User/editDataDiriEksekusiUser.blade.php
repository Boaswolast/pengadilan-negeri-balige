                    ...
                    <div class="card-body border-top">
                        ...
                        <form action="{{route('updateDataDiriEksekusi', ['id' => $data->id_data_diri])}}" method="POST" novalidate>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-8">
                                    <input type="date" name="tanggal_lahir" id="tanggal_lahir" class="form-control @error('tanggal_lahir') is-invalid @enderror" placeholder="Tanggal Lahir" title="Mohon mengisi bagian ini" value="{{$data->tanggal_lahir}}">
                                    @error('tanggal_lahir')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-8">
                                    <input type="text" name="nik" id="nik" class="form-control @error('nik') is-invalid @enderror" placeholder="NIK" title="Mohon mengisi bagian ini" value="{{$data->nik}}">
