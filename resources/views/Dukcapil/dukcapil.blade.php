    ...
    <div class="row">
        <div class="card mt-3">
            ...
            <table class="table datatable-basic">
                ...
                <tbody>
                    @if ($data->count() > 0)
                        @foreach ($data as $capil)
                        <tr>
                            <td>{{$loop->iteration}}</td>
                            <td>{{$capil->penggugat}}</td>
                            <td>{{$capil->tergugat}}</td>
                            <td>{{$capil->tanggal_permohonan}}</td>
                            <td>{{$capil->status_permohonan}}</td>
                                ...
                                <div class="d-inline-flex">
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-end">
                                            <a href="{{route('detailDukcapil', ['id' => $capil->id_peristiwa_penting])}}" class="dropdown-item text-info">
