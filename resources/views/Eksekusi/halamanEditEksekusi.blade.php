                    ...
                    @foreach ($eksekusi as $id)
                        <form action="{{route('tetapkanEditEksekusi', ['id' => $id->id_eksekusi])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-8">
                                    <input type="date" name="tgl_eksekusi" value="{{$id->tgl_eksekusi}}" class="form-control @error('tgl_eksekusi') is-invalid @enderror" placeholder="Tannggal Eksekusi" required>
                                    @error('tgl_eksekusi')
