            ...
            <div class="card">
                <div class="card-body border-top">
                    @foreach ($eksekusi as $id)
                        <form action="{{route('konfirmasiData', ['id' => $id->id_telaah])}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row mb-3">
                                <label class="col-lg-4 col-form-label">Status</label>
                                <div class="col-lg-8">
                                    <input type="text" value="Diterima" name="status_telaah" class="form-control" placeholder="Diterima" readonly required>
                                </div>
                            </div>
