                    ...
                    @foreach ($eksekusi as $id)
                        <form action="{{route('tolakData', ['id' => $id->id_telaah])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-lg-8">
                                    <input type="file" name="resume" class="form-control @error('resume') is-invalid @enderror" data-show-upload="false" data-show-caption="true" data-show-preview="true" accept=".pdf, .doc, .docx" placeholder="File Resume">
                                    @error('resume')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
