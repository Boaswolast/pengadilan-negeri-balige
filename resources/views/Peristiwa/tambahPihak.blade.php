                ...
                <div class="card-body border-top">
                    <form action="{{route('storePihakPeristiwa',$id)}}" method="POST" novalidate>
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-lg-8">
                                <select class="form-select @error('status_pihak') is-invalid @enderror" name="status_pihak" id="status_pihak" required>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-3">
                                <input type="number" name="umur" name="umur" class="form-control @error('umur') is-invalid @enderror" placeholder="Umur" value="{{ old('umur') }}" required>
                                @error('umur')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
