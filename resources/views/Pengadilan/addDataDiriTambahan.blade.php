        ...
        <div class="col-lg-8 offset-lg-2 mt-4">
            <div class="card">
                ...
                <div class="card-body border-top">
                    <form action="{{route('storePihakPengadilan',$id)}}" method="POST" id="formDataDiri" novalidate>
                        @csrf
                        ...
                        <div class="row mb-3 mt-3">
                            ...
                            <div class="col-lg-8">
                                <select class="form-select" name="jenis_pihak" value="{{ old('jenis_pihak') }}" required>
