...
const QuillEditor = function() {
    ...
    const _componentQuill = function() {
        ...
        form.addEventListener('submit', function(event) {
            const petitumInput = form.querySelector('#petitum-input');
            petitumInput.value = quillPlaceholder.root.innerHTML; // Menyalin konten HTML dari Quill ke input tersembunyi
        });
        // Scrollable editor
